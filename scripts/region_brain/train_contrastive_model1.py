...
from preprocessing import SingleRegionEmbBatchedDataset, get_balanced_batch
...
def main(config):
    ...
    dataset = SingleRegionEmbBatchedDataset(metadata, batch_files=batch_files, target_struct_name="Left-Hippocampus") 
